...
public class SetPedoView extends View {
	...
	public SetPedoView(Context context, AttributeSet attrs, int defStyle) {
	...
	public SetPedoView(Context context, AttributeSet attrs) {
		super(context, attrs);
		mContext = context;
		initViewAttrs(attrs);
		mArcRectF = new RectF();
	...
	private void initViewAttrs(AttributeSet attrs) {
		...
		mProgressPaint.setColor(getResources().getColor(R.color.color_top_bg));
