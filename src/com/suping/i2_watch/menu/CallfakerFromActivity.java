...
public class CallfakerFromActivity extends Activity {
	...
	private LinearLayout customEdit;
	...
	private void initViews() {
		...
		customEdit = (LinearLayout) findViewById(R.id.custom);
		mListView = (ListView) findViewById(R.id.listV);
		edName = (EditText) findViewById(R.id.ed_name);
		edPhone = (EditText) findViewById(R.id.ed_phone);
		mListView.setAdapter(new ArrayAdapter<String>(
				CallfakerFromActivity.this,
				android.R.layout.select_dialog_singlechoice, new String[] {
						"通讯录随机抽取", "从通讯录中选择", "自定义联系人" }));
//		mListView.setAdapter(new MyAdapter());
				...
				if (phoneCount > 0) {
					...
					if (phonesCursor.moveToFirst()) {
						do {
							...
							Log.e("通讯录", "联系人姓名： " + disPlayName + "，联系人电话: "
									+ phoneNumber);
	...
	public String getRandom(){
		...
		Log.e("listView",list==null? "空" : list.size()+"");
	    int i =  (int)(Math.random()*list.size())+1 ;
	 	Log.e("listView","随机--" + i);
	 	Log.e("listView","随机--" + list.get(i).toString()); 
