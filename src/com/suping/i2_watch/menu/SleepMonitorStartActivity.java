...
public class SleepMonitorStartActivity extends AbstractSetTimeActivity {
	...
	public void initValue() {
		String hour = (String) SharedPreferenceUtil.get(SleepMonitorStartActivity.this, I2WatchProtocolData.SHARE_MONITOR_START_HOUR,
				"07");
		npHour.setValue(Integer.valueOf(hour));

		String min = (String) SharedPreferenceUtil.get(SleepMonitorStartActivity.this, I2WatchProtocolData.SHARE_MONITOR_START_MIN,
				"00");
