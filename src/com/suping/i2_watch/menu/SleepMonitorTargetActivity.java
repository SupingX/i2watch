...
public class SleepMonitorTargetActivity extends AbstractSetTimeActivity{
	...
	public void initValue() {
		String hour = (String) SharedPreferenceUtil.get(SleepMonitorTargetActivity.this, SleepMonitorActivity.SHARE_MONITOR_TARGET_HOUR,
				"07");
		npHour.setValue(Integer.valueOf(hour));

		String min = (String) SharedPreferenceUtil.get(SleepMonitorTargetActivity.this, SleepMonitorActivity.SHARE_MONITOR_TARGET_MIN,
				"00");
